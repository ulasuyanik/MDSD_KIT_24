 ...
 * </p>
 * <ul>
 *   <li>{@link mdsd.component_based.ViewPoint.impl.EDeploymentViewPointImpl#getEnvironmentviewtype <em>Environmentviewtype</em>}</li>
 *   <li>{@link mdsd.component_based.ViewPoint.impl.EDeploymentViewPointImpl#getAllocationviewtype <em>Allocationviewtype</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EDeploymentViewPointImpl extends MinimalEObjectImpl.Container implements EDeploymentViewPoint {
	...
	protected EClass eStaticClass() {
		return ViewPointPackage.Literals.EDEPLOYMENT_VIEW_POINT;
	}
	...
	public NotificationChain basicSetEnvironmentviewtype(EEnvironmentViewType newEnvironmentviewtype,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ViewPointPackage.EDEPLOYMENT_VIEW_POINT__ENVIRONMENTVIEWTYPE, oldEnvironmentviewtype,
		...
		if (newEnvironmentviewtype != environmentviewtype) {
			...
			if (environmentviewtype != null)
				msgs = ((InternalEObject) environmentviewtype).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ViewPointPackage.EDEPLOYMENT_VIEW_POINT__ENVIRONMENTVIEWTYPE, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ViewPointPackage.EDEPLOYMENT_VIEW_POINT__ENVIRONMENTVIEWTYPE, newEnvironmentviewtype,
					newEnvironmentviewtype));
	}
	...
	public NotificationChain basicSetAllocationviewtype(EAllocationViewType newAllocationviewtype,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ViewPointPackage.EDEPLOYMENT_VIEW_POINT__ALLOCATIONVIEWTYPE, oldAllocationviewtype,
		...
		if (newAllocationviewtype != allocationviewtype) {
			...
			if (allocationviewtype != null)
				msgs = ((InternalEObject) allocationviewtype).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ViewPointPackage.EDEPLOYMENT_VIEW_POINT__ALLOCATIONVIEWTYPE, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ViewPointPackage.EDEPLOYMENT_VIEW_POINT__ALLOCATIONVIEWTYPE, newAllocationviewtype,
					newAllocationviewtype));
	}
